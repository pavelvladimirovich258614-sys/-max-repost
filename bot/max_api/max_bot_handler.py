...
2. Добавьте подписчика «Репост» (@id752703975446_1_bot).

3. Перейдите в <b>Настройки канала</b> ➡️ <b>Администраторы</b>.
4. Добавьте администратора «Репост» (@id752703975446_1_bot).
5. Включите функцию «<b>Писать посты</b>» и нажмите «Сохранить».

👉 Теперь <b>вернитесь в ТГ бота @maxx_repost_bot</b> и пришлите ему <b>ссылку на канал в MAX</b>

<i>Если Max не находит бота по нику — попробуйте найти по названию «Репост».</i>
