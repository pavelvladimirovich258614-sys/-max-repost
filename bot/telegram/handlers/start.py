...
<b>📋 Как подключить Max-канал:</b>

1. Добавьте бота @{TG_BOT_USERNAME} в администраторы Telegram-канала
2. Откройте <b>Настройки канала ➡ Подписчики</b> в Max
3. Добавьте подписчика «Репост» ({MAX_BOT_USERNAME})
4. Перейдите в <b>Настройки канала ➡ Администраторы</b> в Max
5. Добавьте администратора «Репост» ({MAX_BOT_USERNAME})
6. Включите <b>«Писать посты»</b> и сохраните

⚠️ Если Max не находит бота по нику — попробуйте найти по названию «Репост»
